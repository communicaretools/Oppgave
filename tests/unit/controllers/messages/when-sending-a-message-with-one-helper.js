describe('when sending a message with one helper', function(){
	var msgCtrl;
	var scope;
	beforeEach(module(
	...
	it('should have gotten a helper and selected the one', function(){
		expect(msgCtrl.helpers.length).toBe(1);
		expect(msgCtrl.helpers[0].selected).toBe(true);
	});
